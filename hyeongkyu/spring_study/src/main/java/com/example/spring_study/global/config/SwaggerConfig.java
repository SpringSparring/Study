package com.example.spring_study.global.config;
...
/**
 * packageName   : com.example.spring_study.global.config
 * Author        : imhyeong-gyu
 * Data          : 2025. 2. 8.
 * Description   :
 */
...
public class SwaggerConfig {
    ...
    public OpenAPI openApi() {
        ...
        return new OpenAPI()
                ...
                .externalDocs(new ExternalDocumentation().description("log API"));
    }
}
